...
> This file described how the docs app was _first_ stood up: baking `@carbon/config` theme tokens, Geist
...
- Shiki maps both "light" and "dark" to `github-dark-default` precisely _because_ there is no dark mode.
- The Carbon wordmark lockup is `docs/public/grovyn.png` (mark + "carbon"); the `*-light`
